                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="sm:col-span-8 lg:col-span-7">
                                        <h2 class="text-2xl font-bold text-gray-900 sm:pr-12">Tên Sách: {{ book.name }}
                                        </h2>

                                        <!-- Phần thông tin sách -->
                                        <section aria-labelledby="information-heading" class="mt-2">
                                            <h3 id="information-heading" class="sr-only">Thông tin sách</h3>
                                            <div class="flex justify-between">
                                                <p class="text-lg text-gray-900">Tên tác giả: {{ book.author.name }}</p>
                                                <p class="text-lg text-gray-900">{{ book.price }} VNĐ/ngày</p>
                                            </div>
                                        </section>
